...
function register_new_user($username, $password_hash, $surname, $forename) {
    $insert_access_record_template = "INSERT INTO ACCESS VALUES (default, UNIX_TIMESTAMP(NOW()), '0', :password_hash);";
    $insert_access_record_params = array(
        ':password_hash' => $password_hash,
    );

    $insert_detail_record_template = "INSERT INTO DETAILS VALUES (default, :surname, :forename);";
    $insert_detail_record_params = array(
        ':surname' => $surname,
        ':forename' => $forename,
    );

    $insert_user_record_template = "INSERT INTO USERS VALUES (default, :username, UNIX_TIMESTAMP(NOW()), :access_id, :details_id);";
